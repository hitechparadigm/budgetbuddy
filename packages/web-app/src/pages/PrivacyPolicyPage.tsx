      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-[var(--color-surface)] dark:bg-gray-800 rounded-lg shadow-sm border border-[var(--color-border)] dark:border-gray-700 p-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <h3 className="text-lg font-medium text-[var(--color-foreground)] dark:text-gray-200 mb-3">
              2.1 Information You Provide
            </h3>
            <ul className="list-disc pl-6 text-[var(--color-muted-foreground)] dark:text-gray-300 mb-4 space-y-2">
