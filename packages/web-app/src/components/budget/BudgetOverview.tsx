...
export const BudgetOverview: React.FC<BudgetOverviewProps> = ({
  ...
  if (loading) {
    return (
      <div className="bg-[var(--color-surface)] shadow rounded-lg p-6">
  ...
  return (
    <div className="bg-[var(--color-surface)] shadow rounded-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        ...
        {/* Remaining Balance */}
        <div
          className={`${budget.remainingBalance >= 0 ? "bg-[var(--color-background)] border-[var(--color-border)]" : "bg-red-50 border-red-200"} border rounded-lg p-4`}
        >
          <div className="flex items-center justify-between">
            <div>
              <p
                className={`text-sm font-medium ${budget.remainingBalance >= 0 ? "text-[var(--color-muted-foreground)]" : "text-red-600"}`}
              >
                Remaining
              </p>
