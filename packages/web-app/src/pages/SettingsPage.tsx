...
import { detectUserTimezone, formatDateInTimezone } from '../utils/timezoneHelpers';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Location & Timezone</h2>
          ...
          <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1">
                <div className="font-medium text-gray-900 mb-1">Current Timezone</div>
                <div className="text-sm text-gray-600 mb-2">{getTimezoneDisplayName()}</div>
          ...
          <form onSubmit={handleLocationUpdate} className="space-y-4">
            ...
            <div className="pt-4">
              <button
                type="submit"
                disabled={saving || !locationForm.country || !locationForm.city || !locationForm.zipCode}
          ...
          <div className="mt-4 p-3 bg-gray-50 border border-gray-200 rounded-lg">
            <p className="text-sm text-gray-600">
              <strong>Note:</strong> Your timezone is automatically detected from your location.
              Updating your location will adjust your timezone accordingly, ensuring all dates and
              times in the app are displayed correctly for your region.
            </p>
          </div>
        </div>
